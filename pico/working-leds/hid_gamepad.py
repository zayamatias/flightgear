...
class Gamepad:
    ...
    def __init__(self, devices,up,usg):
        ...
        ``usage``.
        """
        self._gamepad_device = find_device(devices, usage_page=up, usage=usg)
    ...
    def getReport(self,report_id=0):
        led_report = self._gamepad_device.get_last_received_report(report_id)
