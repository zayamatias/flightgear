...
alt1_path = "/home/pi/fgmod/images/asi2.png"  # Replace "example.png" with the path to your PNG image
...
def draw_ias(screen, values):
    ias = int(values[2]['value'])
    print(ias)
    pos = (screen.get_width()/2, (screen.get_height()/2)+20)
    screen.fill((100, 100, 100))
    # Blit the image onto the screen
    screen.blit(alt1, (alt1_x,alt1_y+20))
    draw_needles(screen,SCREEN_WIDTH,SCREEN_HEIGHT,ias,1,1)
